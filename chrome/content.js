...
function createFloatingButton(textarea) {
    ...
    floatingButton.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" width="30" height="30">
            <path cx="9" cy="9" r="1" fill="#588D3F" stroke="#FFFFFF" stroke-width="10" d="M175 90A85 85 0 0 1 90 175 85 85 0 0 1 5 90a85 85 0 0 1 170 0z"/>
            <path x="3.5" y="3.5" width="11" height="11" rx="1.5" fill="none" stroke="#FFFFFF" stroke-width="10" d="M50 35h80l15 15v80a15 15 0 0 1 -15 15H50a15 15 0 0 1 -15 -15V50a15 15 0 0 1 15 -15z"/>
            <path fill="#F4F6F9" d="m80.85 65.63 -15.22 48.75h6.32l4.56 -15.12H92.1l4.71 15.12h6.47l-15.15 -48.75zm-3.16 28.86 4.19 -13.6c0.88 -3.04 1.62 -6.36 2.28 -9.47h0.22c0.66 3.04 1.4 6.29 2.35 9.55l4.26 13.52zm35.3 -28.65a3.75 3.75 0 0 0 -3.82 3.91c0 2.17 1.54 3.83 3.75 3.83h0.07a3.66 3.66 0 0 0 3.83 -3.83c0 -2.24 -1.54 -3.91 -3.83 -3.91m-3.02 13.52h6.18v35.01h-6.18z"/>
        </svg>`;
